...
public class UpdateCoHoiBanHangCommand implements IRequest<CoHoiBanHang> {
    ...
    public UpdateCoHoiBanHangCommand() {}

    public UpdateCoHoiBanHangCommand(String tenThuongVu, String giaiDoan,
    ...
    public UpdateCoHoiBanHangCommand(Integer id, UpdateCoHoiBanHangCommand command) {
        this.id                  = id;
        this.tenThuongVu         = command.tenThuongVu;
        this.giaiDoan            = command.giaiDoan;
        this.khachHangId         = command.khachHangId;
        this.leadId              = command.leadId;
        this.tyLeThanhCong       = command.tyLeThanhCong;
        this.doanhThuKyVong      = command.doanhThuKyVong;
        this.ghiChu              = command.ghiChu;
        this.ngayDuKien          = command.ngayDuKien;
        this.nhanVienPhuTrachId  = command.nhanVienPhuTrachId;
    }
