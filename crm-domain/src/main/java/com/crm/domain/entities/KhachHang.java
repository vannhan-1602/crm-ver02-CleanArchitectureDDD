...
public class KhachHang {
    ...
    public KhachHang(String maKhachHang,
        ...
        this(null, maKhachHang, tenKhachHang, email, soDienThoai,
                loaiKhachHangId, tinhTrangId, maSoThue,
                nhanVienPhuTrachId, false, null, null);
    }
    ...
    public void capNhatThongTin(String tenKhachHang,
                                String email,
                                String soDienThoai,
                                Integer loaiKhachHangId,
                                Integer tinhTrangId,
                                ...
                                Integer nhanVienPhuTrachId) {
        if (this.isDeleted) {
            throw new IllegalStateException("Khong the cap nhat KhachHang da bi xoa");
        }
        if (tenKhachHang != null && !tenKhachHang.isBlank()) {
            this.tenKhachHang = tenKhachHang.trim();
        }
    ...
    public void xoa() {
        if (this.isDeleted) {
            throw new IllegalStateException("KhachHang da bi xoa truoc do");
        }
        this.isDeleted = true;
    }
